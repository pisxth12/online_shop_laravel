<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
      <a class="navbar-brand brand-logo" href="/category">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center">
         ...
         <div class="search-content border-l-2">
            <div class="form-group d-flex gap-2">
              <div class="search-content d-flex justify-content-between border align-items-center">
                ...
                <i class="bi bi-search search_icon px-2"></i>
              </div>
      ...
      {{-- md< --}}
       <form class="ml-auto search-form d-block d-md-none" action="#">
        <div class="form-group">
          <i class="bi bi-search search_icon_sm px-2 text-lg " data-toggle="modal" data-target="#modalSearch"></i>
        </div>
      </form>
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
            ...
            <a class="dropdown-item preview-item">
              <div class="preview-thumbnail">
                <img src="{{ asset('back-end/assets/images/faces/face1.jpg') }}" alt="image" class="img-sm profile-pic">
              </div>
            ...
            <a class="dropdown-item preview-item">
              <div class="preview-thumbnail">
                <img src="{{ asset('back-end/assets/images/faces/face12.jpg') }}" alt="image" class="img-sm profile-pic">
              </div>
              <div class="preview-item-content flex-grow py-2">
